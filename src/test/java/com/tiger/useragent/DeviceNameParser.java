...
/**
 * com.tiger.useragent.DeviceNameParser
 *
 * @author: zhaolihe
 * @email: dayingzhaolihe@126.com
 * @date 2019-07-03 11:09:00
 */
public class DeviceNameParser {

    private final List<String> list = Lists.newArrayList("行业", "7.", "10.", "8.", "9.", "8 英寸", "7 英寸", "10 倍",
            "(", "公开", "移动", "联通", "全网", "电信", "双", "至尊",
            "Wi-Fi", "3G", "4G", "5G", "LTE",
    ...
    public static void main(String[] args) {
        ...
        map.put(DeviceNameParser.class.getResource("/huawei.txt").getFile(), Pair.of("Phone", "Huawei"));
        map.put(DeviceNameParser.class.getResource("/huawei_pad.txt").getFile(), Pair.of("Pad", "Huawei"));
        map.put(DeviceNameParser.class.getResource("/mi.txt").getFile(), Pair.of("Phone", "Xiaomi"));
        map.put(DeviceNameParser.class.getResource("/one_plus.txt").getFile(), Pair.of("Phone", "OnePlus"));
        map.put(DeviceNameParser.class.getResource("/oppo.txt").getFile(), Pair.of("Phone", "OPPO"));
        map.put(DeviceNameParser.class.getResource("/samsung.txt").getFile(), Pair.of("Phone", "Samsung"));
        map.put(DeviceNameParser.class.getResource("/vivo.txt").getFile(), Pair.of("Phone", "vivo"));
        map.put(DeviceNameParser.class.getResource("/lenovo.txt").getFile(), Pair.of("Phone", "Lenovo"));
